...
RegisterNetEvent("SINCOELS:changeStage", function(netId, stage)
...
RegisterNetEvent("SINCOELS:toggleSiren", function(netId, tone)
	if not VehicleConfigs then return end
...
RegisterNetEvent("SINCOELS:toggleBullhorn", function(netId, enabled)
	if not VehicleConfigs then return end
...
RegisterNetEvent("SINCOELS:patternChange", function(netId, patternIndex, enabled)
	if not VehicleConfigs then return end
...
RegisterNetEvent("SINCOELS:vehicleRemoved", function(netId)
...
RegisterNetEvent("SINCOELS:indicatorChange", function(netId, indicator, enabled)
