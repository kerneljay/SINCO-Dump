Vue.component('message', {
    ...
    computed: {
        msgIconClass() {
            const icons = {
                global: 'fa-solid fa-comment',
                rp: 'fa-solid fa-comment',
                ooc: 'fa-solid fa-globe',
                twt: 'fa-brands fa-twitter',
                alert: 'fa-solid fa-circle-exclamation',
                goodalert: 'fa-solid fa-circle-check',
                casinowin: 'fa-solid fa-coins',
                bluealert: 'fa-solid fa-circle-info',
                eventalert: 'fa-solid fa-circle-exclamation',
                tip: 'fa-solid fa-circle-exclamation',
                staff: 'fa-solid fa-users-gear',
                police: 'fa-solid fa-shield-halved',
                faction: 'fa-solid fa-users',
                green: 'fa-solid fa-circle-check',
                cmg_admin: 'fa-solid fa-users-gear',
            };
            return icons[this.type] || 'fa-solid fa-comment';
        },
        textEscaped() {
