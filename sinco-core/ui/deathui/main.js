    ...
    var e = {
            ...
            118: (e, t, n) => {
                ...
                n.r(t), n.d(t, {
                    ...
                    if (t >= 0) {
                        ...
                        n.items ? e.showNestedMenu(n) : e.onClick && (e.onClick(n), e.closeOnClick && (e.close(), fetch("https://sinco-core/disablenuifocus", {
                            method: "POST",
                            body: JSON.stringify({
                                nuifocus: !1
                            })
                    ...
                    var e = this;
                    e.parentItems.length > 0 ? e.returnToParentMenu() : (e.close(), fetch("https://sinco-core/disablenuifocus", {
                        method: "POST",
                        body: JSON.stringify({
                            nuifocus: !1
                        })
            ...
            22: (e, t, n) => {
                ...
                class o extends a.Component {
                    constructor() {
                        super(...arguments), this.state = this.props, this._timerInterval = null, this._countdownSent = !1
                    }
                    componentDidMount() {
                        this.startTimer()
                    }
                    ...
                    componentWillReceiveProps(e) {
                        const t = Number(e.timer || 0),
                            n = Number(this.state.timer || 0);
                        // New death event: restart timer instead of keeping stale endTime
                        if (t > 0 && (t !== n || e.killer !== this.state.killer || e.killerPermId !== this.state.killerPermId)) {
                            this.setState(Object.assign(Object.assign({}, e), {
                                canRespawn: !1,
                                nhsCalled: e.nhsCalled || !1
                            }), (() => this.startTimer()))
                        } else {
                            this.setState(Object.assign(Object.assign({}, e), {
                                ...
                                canRespawn: this.state.canRespawn,
                                percentageLeft: this.state.percentageLeft
                            }))
                        }
                    }
                    clearTimer() {
                        null !== this._timerInterval && (clearInterval(this._timerInterval), this._timerInterval = null)
                    }
                    countdownEnded() {
                        if (this._countdownSent) return;
                        this._countdownSent = !0;
                        fetch("https://sinco-core/countdownEnded", {
                            method: "POST",
                            headers: {
                    ...
                    startTimer() {
                        this.clearTimer();
                        this._countdownSent = !1;
                        const timerSecs = Math.max(0, Number(this.state.timer) || 0);
                        this.setState(Object.assign(Object.assign({}, this.state), {
                            endTime: Date.now() + 1e3 * timerSecs,
                            canRespawn: timerSecs <= 0,
                            timer: timerSecs
                        }));
                        if (timerSecs <= 0) {
                            this.countdownEnded();
                        ...
                        const e = setInterval((() => {
                            ...
                            this.setState(Object.assign(Object.assign({}, this.state), {
                                percentageLeft: timerSecs > 0 ? (timerSecs - n / 1e3) / timerSecs * 100 : 100
                            })), 60 == a && (r += 1, a = 0);
                            let i = `${a}`;
                            a < 10 && (i = `0${a}`), this.setState(Object.assign(Object.assign({}, this.state), {
                                ...
                                timer: 0,
                                timeLeft: "00:00"
                            })), this.countdownEnded(), this.clearTimer())
                        }), 1e3);
                        this._timerInterval = e
                    }
                    render() {
                        const timeLabel = this.state.timeLeft ? this.state.timeLeft : "00:00";
                        const killerName = [this.state.killer, " (ID: ", this.state.killerPermId || "??", ")"];
                        return r.jsx("div", Object.assign({
                            ...
                            children: r.jsxs("div", Object.assign({
                                ...
                                children: [r.jsxs("div", Object.assign({
                                    className: "death-recap"
                                }, {
                                    children: [r.jsxs("div", Object.assign({
                                        className: "death-recap-header"
                                    }, {
                                        children: [this.state.suicide ? r.jsxs("div", Object.assign({
                                            className: "death-recap-header-text"
                                        }, {
                                            children: ["YOU COMMITTED ", r.jsx("span", Object.assign({
                                                className: "death-accent"
                                            }, {
                                                children: "SUICIDE"
                                            }), void 0)]
                                        }), void 0) : r.jsxs("div", Object.assign({
                                            className: "death-recap-header-text"
                                        }, {
                                            ...
                                            className: "death-recap-header-right"
                                        }, {
                                            children: [r.jsxs("div", Object.assign({
                                                className: "death-recap-header-mic"
                                            }, {
                                                children: [r.jsxs("div", Object.assign({
                                                    className: "death-mic-top"
                                                }, {
                                                    children: [r.jsxs("svg", Object.assign({
                                                        className: "mic-icon",
                                                        id: "death-mic-icon",
                                                        width: "16",
                                                        height: "25",
                                                        ...
                                                        children: [r.jsx("path", {
                                                            ...
                                                            d: "M7.99966 0C5.29377 0 3.08789 2.20588 3.08789 4.91176V12.8824C3.08789 15.6176 5.29377 17.7941 7.99966 17.8235C10.7055 17.8235 12.9114 15.6176 12.9114 12.9118V4.91176C12.9114 2.20588 10.7055 0 7.99966 0Z"
                                                        }, void 0)]
                                                    }), void 0), r.jsx("img", {
                                                        className: "mic-icon mic-icon--muted",
                                                        id: "death-mic-muted",
                                                        src: "../money/img/muted-mic.svg",
                                                        alt: "",
                                                        style: {
                                                            display: "none"
                                                        }
                                        ...
                                        className: "death-recap-card"
                                    }, {
                                        children: [r.jsx("div", Object.assign({
                                            className: "death-recap-title"
                                        }, {
                                            children: "COMBAT SUMMARY"
                                        }), void 0), r.jsxs("div", Object.assign({
                                            className: "death-recap-row"
                                        }, {
                                            children: [r.jsxs("div", Object.assign({}, {
                                                children: [r.jsxs("div", Object.assign({
                                                    className: "death-recap-big"
                                                }, {
                                                    children: [r.jsx("span", Object.assign({
                                                        className: "death-recap-num dealt"
                                                    }, {
                                                        children: "0"
                                                    }), void 0), r.jsx("span", Object.assign({
                                                        className: "death-recap-unit"
                                                    }, {
                                                        children: "DMG"
                                                    }), void 0)]
                                                }), void 0), r.jsx("div", Object.assign({
                                                    className: "death-recap-mini"
                                                }, {
                                                    children: "DEALT"
                                                }), void 0)]
                                            }), void 0), r.jsxs("div", Object.assign({}, {
                                                children: [r.jsxs("div", Object.assign({
                                                    ...
                                                    children: [r.jsx("span", Object.assign({
                                                        className: "death-recap-num took"
                                                    }, {
                                                        children: "0"
                                                    }), void 0), r.jsx("span", Object.assign({
                                                        className: "death-recap-unit"
                                            ...
                                            className: "death-recap-barrow"
                                        }, {
                                            children: [r.jsx("span", Object.assign({
                                                className: "death-recap-label"
                                            }, {
                                                children: "HEALTH"
                                            }), void 0), r.jsx("div", Object.assign({
                                                className: "death-recap-bar"
                                            }, {
                                                children: r.jsx("div", {
                                                    className: "death-recap-fill",
                                                    style: {
                                                        width: "0%"
                                                    }
                                                }, void 0)
                                            }), void 0), r.jsx("span", Object.assign({
                                                className: "death-recap-value"
                                            }, {
                                                children: "0"
                                            }), void 0)]
                                        }), void 0), r.jsxs("div", Object.assign({
                                            ...
                                            children: [r.jsx("span", Object.assign({
                                                ...
                                                children: r.jsx("div", {
                                                    className: "death-recap-fill death-recap-fill-armour",
                                                    style: {
                                                        width: "0%"
                                                    }
                                                }, void 0)
                                        ...
                                        children: [r.jsx("div", Object.assign({
                                            ...
                                            children: "NEAREST MEDICS"
                                        }), void 0), r.jsxs("div", Object.assign({
                                            className: "death-recap-medics"
                                        }, {
                                            children: [r.jsx("div", Object.assign({
                                                className: "death-recap-medic is-empty"
                                            }, {
                                                children: r.jsxs("div", Object.assign({
                                                    className: "death-recap-medic-line"
                                                }, {
                                                    children: [r.jsx("span", Object.assign({
                                                        className: "death-recap-medic-name"
                                                    }, {
                                                        children: "\u2014"
                                                    }), void 0), r.jsx("span", Object.assign({
                                                        className: "death-recap-medic-sep"
                                                    }, {
                                                        children: "|"
                                                    }), void 0), r.jsx("span", Object.assign({
                                                        className: "death-recap-medic-dist"
                                                    }, {
                                                        children: "\u2014"
                                                    }), void 0)]
                                                }), void 0)
                                            ...
                                            className: "death-recap-actions-wrap"
                                        }, {
                                            children: [this.state.nhsCalled && !this.state.canRespawn && r.jsx("div", Object.assign({
                                                className: "death-recap-nhs-blocked-overlay"
                                            }, {
                                                children: "AMBULANCE HAVE BEEN NOTIFIED"
                                            }), void 0), r.jsxs("div", Object.assign({
                                                className: "death-recap-actions"
                                            }, {
                                                children: [r.jsx("div", Object.assign({
                                                    className: this.state.nhsCalled ? "death-recap-btn disabled" : "death-recap-btn"
                                                }, {
                                                    children: this.state.nhsCalled ? "AMBULANCE CALLED" : "PRESS [E] TO CALL AMBULANCE"
                                                }), void 0), r.jsx("div", Object.assign({
                                                    className: this.state.canRespawn ? "death-recap-btn primary" : "death-recap-btn primary disabled"
                                                }, {
                                                    children: this.state.canRespawn ? "PRESS [R] TO RESPAWN" : timeLabel
                                                }), void 0)]
                                            }), void 0)]
                                        }), void 0)]
                                    }), void 0)]
                        ...
                        if (1 == e.data.openMenu)
                            if ("ped" == e.data.type) {
                                ...
                                t = 1 == e.data.police ? new o.default({
                                    ...
                                    menuItems: u,
                                    onClick: function(t) {
                                        fetch("https://sinco-core/radialClick", {
                                            method: "POST",
                                            body: JSON.stringify({
                                                itemid: t.id,
                ...
                class h extends l.Component {
                    constructor(e) {
                        super(e), this.state = {
                            ...
                            } else if (37 === t.keyCode || 65 === t.keyCode) {
                                t.preventDefault && t.preventDefault();
                        ...
                        }), this.locations = (Array.isArray(this.props.locations) ? this.props.locations : []).map(((e, t) => s.jsx(f.SwiperSlide, Object.assign({
                            id: t + "",
                    ...
                    componentDidMount() {
                        window.addEventListener("keydown", this.handleDownEvent, !0)
                    }
                    componentWillUnmount() {
                        window.removeEventListener("keydown", this.handleDownEvent, !0)
                    }
                    componentDidUpdate(e) {
                        if (e.locations !== this.props.locations) {
                            const t = Array.isArray(this.props.locations) ? this.props.locations : [];
                            this.locations = t.map(((e, n) => s.jsx(f.SwiperSlide, Object.assign({
                                id: n + "",
                                className: "swiper-slide"
                            }, {
                                children: s.jsx(c.default, {
                    ...
                    onSlide(e) {
                        const t = e.slides;
                        const locs = Array.isArray(this.props.locations) ? this.props.locations : [];
                        for (let e of t)
                    ...
                    cycleSpawn(dir) {
                        const sw = this.state.swiper;
                        const locs = Array.isArray(this.props.locations) ? this.props.locations : [];
                        if (!sw || locs.length < 2) return;
                        sw.allowSlideNext = !0;
                        sw.allowSlidePrev = !0;
                        if (sw.params && sw.params.loop) {
                            dir > 0 ? sw.slideNext() : sw.slidePrev();
                            return
                        }
                        const max = Math.max(0, (sw.slides && sw.slides.length ? sw.slides.length : locs.length) - 1);
                        let idx = typeof sw.realIndex === "number" ? sw.realIndex : (sw.activeIndex || 0);
                    ...
                    render() {
                        const locCount = Array.isArray(this.props.locations) ? this.props.locations.length : 0;
                        const slidesPerView = locCount <= 1 ? 1 : Math.min(5, locCount - 1);
                        const useLoop = locCount > slidesPerView;
                        return s.jsx(s.Fragment, {
                            children: s.jsx("div", Object.assign({
                                className: "sinco-spawn"
                            }, {
                                children: s.jsxs("div", Object.assign({
                                    className: "sinco-locations"
                                }, {
            ...
            674: function(e, t, n) {
                ...
                n(724), t.default = o.connect((e => ({
                    ...
                    function C() {
                        fetch("https://sinco-core/closeStatsMenu", {
                            method: "POST",
                            body: "{}"
                        })
                    }
                    ...
                    return i.useEffect((() => {
                        const t = Array.isArray(e.playerStats) ? e.playerStats.slice() : [];
                        d(s.default.chunk(t.sort(b), 15))
                    }), [e.playerStats]), i.useEffect((() => {
                        if ("ALL TIME" === r) {
                            const t = Array.isArray(e.playerStatsTotal) ? e.playerStatsTotal.slice() : [];
                            t.sort(b), d(s.default.chunk(t, 15)), v(S(t))
                        } else {
                            const t = Array.isArray(e.playerStats) ? e.playerStats.slice() : [];
                            t.sort(b), d(s.default.chunk(t, 15)), v(S(t))
                        }
                        ...
                        const onKey = ev => {
                            if ("Escape" === ev.key || "Esc" === ev.key || 27 === ev.keyCode) C()
                        };
                        const onMsg = ev => {
                            const data = ev && ev.data;
                            if (data && "sincoBridgeKey" === data.type && "Escape" === data.key) C()
                        };
                        ...
                        children: a.jsxs("div", Object.assign({
                            className: "st-shell",
                            "data-category": x[t] || "factions"
                        }, {
                            children: [a.jsx("div", Object.assign({
                                className: "st-headerRow"
                            }, {
                                children: a.jsxs("div", Object.assign({
                                    className: "st-headerTitleWrap"
                                }, {
                                    children: [a.jsx("div", Object.assign({
                                        className: "st-headerTitle"
                                    }, {
                                        children: "STATISTICS"
                                ...
                                children: a.jsxs("div", Object.assign({
                                    ...
                                    children: [a.jsxs("div", Object.assign({
                                        ...
                                        children: [a.jsxs("div", Object.assign({
                                            ...
                                            children: a.jsx("button", Object.assign({
                                                className: "button",
                                                onClick: () => o("THIS MONTH" == r ? "ALL TIME" : "THIS MONTH")
                                            }, {
                                                children: r
                                            }), void 0)
                                        }), void 0)]
                                        ...
                                        children: a.jsxs("table", Object.assign({
                                            ...
                                            children: [a.jsxs("thead", {
                                                children: [a.jsxs("tr", {
                                                    children: [a.jsx("th", {
                                                        children: "Rank"
                                                    }, void 0), a.jsx("th", {
                                                        children: "Name"
                                                    }, void 0), Object.entries((e.tableCategories && e.tableCategories[t]) || {}).map((e => a.jsx("th", Object.assign({
                                                        className: "header",
                                                        onClick: () => {
                                                ...
                                                children: [null != h && f > 0 && a.jsxs("tr", {
                                                    children: [a.jsxs("td", Object.assign({
                                                        ...
                                                        children: h.name
                                                    }), void 0), Object.entries((e.tableCategories && e.tableCategories[t]) || {}).map((e => a.jsx("td", Object.assign({
                                                        className: "pinned-local-player"
                                                    }, {
                                                    ...
                                                    children: [a.jsxs("td", {
                                                        ...
                                                        children: n.name
                                                    }, void 0), Object.entries((e.tableCategories && e.tableCategories[t]) || {}).map((e => a.jsx("td", {
                                        ...
                                        children: (() => {
                                            ...
                                            const r = t.splice(Math.max(0, m - 1), 6);
                                            return m > 1 && r.unshift(a.jsx("button", Object.assign({
                                                className: null,
                                                onClick: () => g(m - 1)
                                            }, {
                                                children: m - 1
            ...
            629: function(e, t, n) {
                ...
                const f = r(n(391)),
                    ...
                    h = s.connect((e => ({
                        ...
                        function applyDeathMic(level, talking, muted) {
                            var lvl = Number(level) || 1;
                            if (lvl < 1) lvl = 1;
                            if (lvl > 3) lvl = 3;
                            var bars = document.querySelectorAll("#death-mic-level .mic-bar");
                            for (var i = 0; i < bars.length; i++) {
                                var bn = Number(bars[i].getAttribute("data-n")) || 0;
                                bars[i].classList.remove("active", "talking", "muted", "mutedActive");
                                if (muted) {
                                    bars[i].classList.add("muted");
                                    if (bn <= lvl) bars[i].classList.add("mutedActive");
                                } else if (bn <= lvl) {
                                    bars[i].classList.add("active");
                                    if (talking) bars[i].classList.add("talking");
                                }
                            }
                            var icon = document.getElementById("death-mic-icon");
                            var mutedIcon = document.getElementById("death-mic-muted");
                            if (icon && mutedIcon) {
                                if (muted) {
                                    ...
                                    if (talking) icon.classList.add("talking");
                                    else icon.classList.remove("talking");
                                }
                            }
                        }
                        function t(t) {
                            ...
                            if (n.updateCmgMic == true) {
                                applyDeathMic(n.micLevel, n.micTalking, n.micMuted);
                                return
                            }
                            if (n.updateMoney == true && n.micLevel != null) {
                                applyDeathMic(n.micLevel, n.micTalking, n.micMuted)
                            }
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    switch (n.type) {
                        ...
                        case "SHOW_DEATH_SCREEN":
                            {
                                ...
                                return Object.assign(Object.assign({}, e), {
                                    page: "deathscreen",
                                    deathscreen: {
                                        timer: Number(info.timer) || 0,
                                        killer: info.killer || "N/A",
                                        killerPermId: info.killerPermId || "N/A",
                                        killedByWeapon: info.killedByWeapon || "N/A",
                        ...
                        case "RESPAWN_BUTTON_CLICK":
                            return fetch("https://sinco-core/respawnButtonClicked", {
                                method: "POST",
                                body: JSON.stringify({
                                    location: e.spawn && e.spawn.selectedSpawn
                                })
                            }), e;
                        case "SET_SPAWN_LOCATIONS":
                            {
                                const info = n.info || {};
                                const locs = Array.isArray(info.locations) ? info.locations : [];
                                return Object.assign(Object.assign({}, e), {
                                    page: "spawn",
                                    spawn: Object.assign(Object.assign({}, e.spawn || {}), {
                                        locations: locs,
                                        selectedSpawn: locs[0] || null
                                    })
                                })
                            }
                        case "SET_STATS":
                            {
                                const info = n.info || {};
                                return Object.assign(Object.assign({}, e), {
                                    playerStats: Array.isArray(info.stats) ? info.stats : [],
                                    playerStatsTotal: Array.isArray(info.statsTotal) ? info.statsTotal : [],
