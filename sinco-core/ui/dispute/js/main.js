...
$.post(`https://sinco-core/newMessage`,JSON.stringify({
message:newMessage
}),function(){
...
var titleEl=document.getElementById('disputeNotiTitle');
var descEl=document.getElementById('disputeNotiDesc');
...
if(isEscape){
$.post('https://sinco-core/closeDisputeMenu',JSON.stringify({}));
}
};
...
var closeButton=document.getElementById('dispute-close');
...
$.post(`https://sinco-core/openPReport`,JSON.stringify({
}));
});
}
...
$.post(`https://sinco-core/mutePlr`,JSON.stringify({
...
if(blockButton)blockButton.addEventListener('click',function(){
console.log('Block button clicked');
if(selectedPlayer===null){
showNotification('Dispute System','No player selected');
return;
}
$.post(`https://sinco-core/blockPlr`,JSON.stringify({
user2bMuted:selectedPlayer.id
}));
...
$.post(`https://sinco-core/delPlr`,JSON.stringify({
user2bMuted:selectedPlayer.id
})).done(function(){
var playersList=document.getElementById('dispute-players-list');
playersList.innerHTML='';
