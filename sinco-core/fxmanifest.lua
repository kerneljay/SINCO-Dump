...
name "sinco-core"
author "SINCO"
description "SINCO core resource"
resource_type "map" { gameTypes = { fivem = true } }
map "map.lua"
shared_script "@loader/shared/clientloader.lua"

ui_page "ui/nui_bridge.html"
...
files{
  ...
  "ui/speedometer/electric.css",
  "ui/speedometer/electric.html",
  "ui/speedometer/electric/*.png",
  ...
  "ui/money/img/*.webp",
  "ui/money/img/*.svg",
  "ui/money/img/vehicle/*.svg",
  "ui/money/img/vehicle/*.png",
  "ui/money/img/quick/*.png",
  "ui/money/index.js",
  "ui/money/index.css",
  "ui/money/legacy-hud.css",
  "ui/money/overlay-panels.css",
  'ui/loading/**/*',
  "cfg/peds.meta",
  "cfg/hashes.json",
  "ui/wagers/*.js",
  ...
  "ui/blips/*.png",
  "ui/assets/*.png",
  -- Merged death / spawn / stats UI (ex-sincoui)
  "ui/deathui/**/*",
  "ui/deathui/*.webp",
  "ui/deathui/*.png",
  "ui/deathui/*.otf",
  -- Merged dispute UI (ex-sincoui2)
  "ui/dispute/**/*",
  -- Merged chat UI
  "chat/dist/**/*",
  "chat/html/**/*",
  ...
  "loadscreen/**/*",
  -- LB Phone SINCOBank + Offshore + Vigilante + Casino apps
  "ui/phone/sincobank/**/*",
  "ui/phone/offshore/**/*",
  "ui/phone/vigilante/**/*",
  "ui/phone/casino/**/*",
...
shared_scripts {
  "util/shared/*",
  "pma/shared.lua",
  	-- "shared/shared_chairs.lua", -- Removed due to conflicts
}
...
server_scripts{ 
  ...
  "modules/events/*.lua",
  "modules/events/sv_colortile.lua",
  "modules/ui/*.lua",
  "modules/menus/*.lua",
  "modules/jobs/*.lua",
  "modules/misc/*.lua",
  ...
  "pma/server/**/*.lua",
	"pma/server/**/*.js",
 -- "modules/misc/sv_sincopoints.lua",
  -- Merged chat
  "chat/sv_chat.lua",
}
...
client_scripts  {
  ...
  -- "client/jobs/cl_vangelico.lua", -- heists disabled
  ...
  "client/events/cl_colortile.lua",
  ...
  "client/ui/cl_sincobank.lua",
  "client/ui/cl_offshore.lua",
  "client/ui/cl_vigilanteapp.lua",
  "client/ui/cl_casinoapp.lua",
  "client/discord/cl_nitro.lua",
  "client/ui/cl_notificationui.lua",
  "client/menus/cl_numberplatechanger.lua",
  -- "client/events/cl_organheist.lua", -- heists disabled
  ...
  -- Merged UI resources (chat / death / dispute / stats)
  "client/ui/deathscreen.lua",
  "client/ui/spawnui.lua",
  "client/ui/cl_statsui.lua",
  "client/ui/cl_dispute.lua",
  "client/ui/cl_nuifocus.lua",
  "chat/cl_chat.lua",
}

-- These files are loaded with LoadResourceFile/module() or register bot exports.
-- Keymaster encrypts them unless they are ignored, which breaks getUserId/getUserSource.
escrow_ignore {
  "cfg/**/*",
  "cfg/*.lua",
  "cfg/item/*.lua",
...
server_export "acGetUserId"
server_export "acHasStaff"
server_export "acBan"
server_export "acKick"
server_export "acLog"
