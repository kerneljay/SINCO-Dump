...
cfg.selectorTypes = {
    ["default"] = {
        _config = {name="Job Selector", blipid = 351, blipcolor = 47, permissions = {}, TextureDictionary = "menus",texture = "clockon"},
        jobs = {
            --{"AA Mechanic", 0},
            --{"Royal Mail Driver", 0},
            --{"Deliveroo", 0},
    ...
    ["police"] = {
        _config = {name="Met Police", blipid = 351, blipcolor = 38, permissions = {"cop.whitelisted"},TextureDictionary = "menus", texture = "clockon"},
    ...
    ["lfb"] = {
        _config = {name="LFB Job", blipid = 351, blipcolor = 1, permissions = {"lfb.whitelisted"}, TextureDictionary = "menus", texture = "sinco_lfbui"},
        jobs = groupCfg.lfbRanks
    },
    ["hmp"] = {
        _config = {name="Prison Guard", blipid = 351, blipcolor = 1, permissions = {"prisonguard.whitelisted"}, TextureDictionary = "menus", texture = "sinco_prisonui"},
        jobs = groupCfg.hmpRanks
    },
    ["vigilante"] = {
        _config = {name="Vigilante", blipid = 351, blipcolor = 47, permissions = {"vigilante.whitelisted"}, TextureDictionary = "menus", texture = "clockon"},
        jobs = groupCfg.vigilanteRanks
    },
...
cfg.selectors = {
    ...
    --vigilante
    {type="vigilante", position=vector3(-438.8489074707,6002.2446289062,31.716241836548)},
