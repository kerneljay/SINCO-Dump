...
cfg.weapons = {
	...
	[`WEAPON_VIGILANTESTINGER`] = {bone = 24818, offset = vector3(0.0, 0.18, 0.0), rotation = vector3(180.0, 148.0, 0.0), model = `w_sb_vigilantestinger`},
	[`WEAPON_VIGILANTESPAR16`] = {bone = 24818, offset = vector3(0.0, 0.18, 0.0), rotation = vector3(180.0, 148.0, 0.0), model = `w_ar_vigilantespar16`},
	...
	[`WEAPON_VIGILANTEMOSIN`] = {bone = 24818, offset = vector3(-0.12, -0.12, -0.13), rotation = vector3(100.0, -3.0, 5.0), model = `w_ar_vigilantemosin`},
